          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  handleChange("startMonth", Number(e.target.value))
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("startYear", Number(e.target.value))
                }
                className="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 text-black"
              />
              {fieldErrors.startYear && (
                <p className="mt-1 text-xs text-red-600">
                  {fieldErrors.startYear[0]}
                </p>
              )}
            </div>
